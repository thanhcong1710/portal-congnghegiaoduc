      ...
      <div class="mb-5">
        ...
        <div class="vx-row mt-3">
          <div class="vx-col w-full">
            <router-link class="btn btn-success" :to="'/lms/branch_transfers/add'">
        ...
        <div class="con-tablex vs-table--content">
          <div class="vs-con-tbody vs-table--tbody ">
            <table class="vs-table vs-table--tbody-table">
              ...
              <tr class="tr-values vs-table--tr tr-table-state-null" v-for="(item, index) in branch_transfers" :key="index">
                <!---->
                ...
                <td class="td vs-table--td text-center list-action"> 
                    <router-link :to="`/lms/branch_transfers/${item.id}/detail`" >
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        this.$vs.loading()
        axios.p('/api/lms/branch_transfers/list', data)
          .then((response) => {
            this.$vs.loading.close()
            this.branch_transfers = response.data.list
