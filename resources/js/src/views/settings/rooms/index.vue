      ...
      <div class="mb-5">
        ...
        <div class="vx-row mt-3">
          <div class="vx-col w-full">
            <router-link class="btn btn-success" :to="'/settings/rooms/add'">
        ...
        <div class="con-tablex vs-table--content">
          <div class="vs-con-tbody vs-table--tbody ">
            <table class="vs-table vs-table--tbody-table">
              ...
              <tr class="tr-values vs-table--tr tr-table-state-null" v-for="(item, index) in rooms" :key="index">
                <!---->
                ...
                <td class="td vs-table--td text-center list-action"> 
                    <router-link :to="`/settings/rooms/edit/${item.id}`">
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        this.$vs.loading()
        axios.p('/api/settings/rooms/list', data)
          .then((response) => {
      ...
      confirmDelete (item) {
        ...
        this.$vs.dialog({
          ...
          color: 'danger',
          title: 'Thông báo',
          text: `Bạn chắc chắn muốn xóa phòng học - ${item.name}?`,
      ...
      deletetuition_fee(){
        ...
        this.$vs.loading();
        axios.p(`/api/settings/rooms/delete`,data)
        .then((response) => {
          this.$vs.loading.close();
          this.getData();
          this.$vs.notify({
