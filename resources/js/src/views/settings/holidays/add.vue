    ...
    <vx-card no-shadow class="mt-5">
      <div class="vx-row">
        <div class="mb-6 vx-col md:w-1/3 w-full">
          ...
          <div class=w-full>
            <input type="text" v-model="holiday.name" class="vs-inputx vs-input--input normal">
          </div>
        </div>
        <div class="mb-6 vx-col md:w-1/3 w-full">
        ...
        <div class="mb-6 vx-col md:w-1/3 w-full">
          ...
          <div class=w-full>
            <vs-switch v-model="holiday.status" color="success"/>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      save() {
        ...
        this.$vs.loading()
        axios.p("/api/settings/holidays/add",{
