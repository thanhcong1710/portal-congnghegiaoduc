      ...
      <div class="mb-5">
        <div class="vx-row">
          <div class="vx-col sm:w-1/4 w-full mb-4">
            ...
            <vs-input class="w-full" placeholder="Tên ca học" v-model="searchData.keyword"></vs-input>
          </div>
          <div class="vx-col sm:w-1/4 w-full mb-4">
        ...
        <div class="vx-row mt-3">
          <div class="vx-col w-full">
            <router-link class="btn btn-success" :to="'/settings/shifts/add'">
        ...
        <div class="con-tablex vs-table--content">
          <div class="vs-con-tbody vs-table--tbody ">
            <table class="vs-table vs-table--tbody-table">
              ...
              <tr class="tr-values vs-table--tr tr-table-state-null" v-for="(item, index) in shifts" :key="index">
                <!---->
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        this.$vs.loading()
        axios.p('/api/settings/shifts/list', data)
          .then((response) => {
            this.$vs.loading.close()
            this.shifts = response.data.list
      ...
      confirmDelete (item) {
        ...
        this.$vs.dialog({
          ...
          color: 'danger',
          title: 'Thông báo',
          text: `Bạn chắc chắn muốn xóa ca học - ${item.name}?`,
      ...
      deletetuition_fee(){
        ...
        this.$vs.loading();
        axios.p(`/api/settings/shifts/delete`,data)
        .then((response) => {
          this.$vs.loading.close();
          this.getData();
          this.$vs.notify({
